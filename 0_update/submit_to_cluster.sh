...
#$ -q rostam.q
#$ -cwd
#$ -o /data.nst/johannes/projects/sahel_finite-observation-dynamic-range/log/
#$ -e /data.nst/johannes/projects/sahel_finite-observation-dynamic-range/log/
...
python $exe --log10_eps ${loge} --log10_h ${logh} --seed $seed --path $path